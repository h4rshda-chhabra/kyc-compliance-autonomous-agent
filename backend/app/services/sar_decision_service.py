...
class SARDecision:
    generate_new: bool
    existing_sar: Optional[SARReport]  # most recent non-archived SAR, if any
    stale_sars: List[SARReport] = field(default_factory=list)  # ALL non-archived SARs to retire on regeneration
